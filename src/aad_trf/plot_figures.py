...
#                         vlim=vlim
#                         )
#     plt.savefig(f"{path_dict['reports']}/dataset-{dataset_name}_reports-scores-topo_config-{config_id}_sub-average.png")
...
# plt.savefig(f"{path_dict['reports']}/dataset-updown-nh-ci_reports-trf-coef-wave_config_sub-average.png")
...
plt.savefig(os.path.join(path_dict['reports'], "all_clf_results.png"))